...
% Last Modified by GUIDE v2.5 07-Dec-2015 12:05:44
...
initial_plt(handles.curr_data, handles.fs, handles.thresh, handles.axes1,handles.axes2);
...
function initial_plt(data,fs,thresh,ax1,ax2) %MAKE PLOTS
    axes(ax1);
